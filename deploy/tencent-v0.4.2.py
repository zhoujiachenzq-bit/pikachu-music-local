#!/usr/bin/env python3
"""Run as root from the v0.4.2 checkout. Never prints container environment values."""
import json
import os
...
CANDIDATE = f'zqmusic-candidate-v042-{STAMP}'
ROLLBACK = f'{APP}-rollback-{STAMP}'
EXPECTED_CACHE = 'pikachu-music-shell-v0.4.2-r1'
...
def main():
    if os.geteuid() != 0:
        raise RuntimeError('Run with sudo python3 deploy/tencent-v0.4.2.py')
    os.umask(0o077)
